            ...
            <div className='w-full h-[70vh] flex justify-center items-center px-5 lg:px-10 xl:px-20 md:h-auto sm:w-[70%] sm:mx-auto md:mx-0 md:w-[50%] lg:my-10'>
                <div className='w-[90%] h-auto flex flex-col gap-2 lg:w-[80%]'>
                    ...
                    <p className="text-gray-600 mt-2">
                        Please enter new Password for abc@qbc
                    </p>

                    <input type="text" placeholder='Enter New Password' className='w-full h-auto px-3 py-2 rounded-3xl border mt-4 mb-2' />
                    <input type="text" placeholder='Confirm New Password' className='w-full h-auto px-3 py-2 rounded-3xl border mb-4' />
