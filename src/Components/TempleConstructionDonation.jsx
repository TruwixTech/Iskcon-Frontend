...
import TempleConstruct from '../assets/templeconstruct.avif'

const backend = import.meta.env.VITE_BACKEND_URL;

function TempleConstructionPage() {
        ...
        >
            ...
            <div className='w-full h-auto flex flex-col px-5 md:px-10 lg:px-20'>
                <h1 className='w-full h-auto text-center text-lg font-prata md:text-2xl xl:text-3xl'>
                    Temple Constuction Donation
                </h1>
                <div className='w-full h-auto flex justify-center items-center my-7 rounded-3xl'>
                    <img src={TempleConstruct} alt="Donate logo" className='w-60 md:w-80 xl:w-96 h-[250px] rounded-3xl' />
                </div>
                <h1 className='w-full h-auto text-center font-prata xl:text-lg'>
                    Try to donate a minimum of Rs. 500, this can be useful for Construction <br /> of Temple.
                </h1>
...
export default TempleConstructionPage