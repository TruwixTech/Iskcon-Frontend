...
const CreateProductPopup = ({ product, closePopup, refreshProducts }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const stringArray = formData.images.filter(
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto flex items-center justify-center bg-gray-800 bg-opacity-50 font-marcellus z-10">
      <div className="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-6xl border-2 border-orange-500">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold font-prata text-gray-700 mb-1">
                Name
              </label>
              <input
                type="text"
          ...
          {/* Images */}
          <div>
            <label className="block text-sm font-bold font-prata text-gray-700 mb-2">
              Images
            </label>
              ...
              {formData.sizes.map((size, index) => (
                <div key={index} className="flex items-center space-x-2">
                  <input
                    ...
                    value={size.sizeType}
                    onChange={(e) =>
                      handleSizeChange(index, "sizeType", e.target.value)
                    }
                    className="p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  <input
