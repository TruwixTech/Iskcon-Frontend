      ...
      <div className="w-full h-auto flex flex-col sm:flex-row sm:justify-center gap-6 bg-gray-100 rounded-xl p-5">
        <div className="w-full h-auto">
          <img
            src={images[0]}
            alt="image"
            className="w-full h-48 rounded-lg bg-gray-200 sm:h-60 md:h-80 object-cover"
          />
        </div>
        <div className="w-full h-auto flex flex-col">
          <h1 className="my-4 lg:my-6 w-full h-auto text-3xl sm:text-2xl md:text-3xl xl:text-4xl font-semibold">
            {singleDonation.title}
          </h1>
          <p
            style={{ whiteSpace: "pre-wrap" }}
            className="w-full h-auto text-sm text-gray-500 sm:text-base lg:text-lg"
          >
