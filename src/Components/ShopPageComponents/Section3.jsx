...
function Section3() {
    const carousal = [
        {
            title: "Make a donation for Srila Prabhupada booksdisctribution directly at ISCKON Ghaziabad",
            id: '1'
        },
        {
            title: "Make a donation for Srila Prabhupada booksdisctribution directly at ISCKON Ghaziabad",
        ...
        <div className='w-full h-auto flex justify-center items-center py-20 lg:pt-24'>
            <div className="relative h-[450px] md:h-[500px] lg:h-[700px]">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex flex-col gap-6 justify-center items-center">
                    <h1 className="text-xl md:text-2xl text-center text-[#3B2106] font-prata lg:text-3xl xl:text-4xl">Donate for Srila Prabhupada <br />
                        Books Distribution Now</h1>
                                    ...
                                    {carousal.map((item, index) => (
                                        ...
                                        >
                                            <div className='w-full h-auto flex flex-col gap-2 md:w-[50%] md:mb-6 lg:gap-8'>
                                                <h3 className="font-semibold text-sm font-prata md:text-lg" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>{item.title}</h3>
                                                <div>
                                                <button className='text-white font-poppins text-sm lg:text-base'>Donate Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
