    ...
    return (
        <div className='w-full h-auto flex flex-col justify-center items-end bg-[#FDE3B6] lg:flex-row-reverse 2xl:h-screen' style={
            ...
            <div className='w-full h-auto flex flex-col pt-10'>
                <h1 className='font-prata text-2xl px-5 md:px-10 sm:text-3xl lg:text-4xl lg:pb-8'>Timeline</h1>
                <div className='w-full h-auto flex flex-col gap-8 my-10 lg:flex-row relative lg:mb-0 lg:overflow-hidden'>
                    <div className='w-full h-auto flex flex-col gap-5 px-5 md:px-10 lg:w-[60%] lg:ml-auto relative z-40 lg:h-[500px] 2xl:w-[55%] xl:gap-8 2xl:mr-10'>
                        <div className='w-full h-auto flex flex-col gap-1'>
                            <h1 className='font-nunito text-xl font-bold sm:text-2xl lg:text-3xl'>The Beginning</h1>
