        ...
        <div className='w-full h-auto flex flex-col bg-[#FDE3B6] px-4 md:px-10 lg:flex-row-reverse 2xl:h-screen' style={
            ...
            <div className='w-full h-auto flex flex-col'>
                <h1 className='font-prata my-20 text-[#3B2106] sm:text-center md:text-3xl lg:text-end lg:text-4xl sm:text-xl 2xl:text-4xl'>
                    ISKCON Wave City Temple Construction has <br /> Restarted. Help Us Build <span className='text-[#EB852C]'>Sri Radha Krishna <br /> Temple.</span>
                </h1>
                <div className='w-full h-auto flex flex-wrap justify-center items-center gap-6 mb-10 overflow-hidden'>
                    {
                        content.map((item, index) => (
                            <div key={index} className='w-[300px] h-72 rounded-full flex justify-center items-center relative 2xl:h-80 2xl:w-[320px]'>
                                <div className='w-[85%] h-[85%] border-[10px] rounded-full border-[#bf9d78] relative flex justify-center items-center'>
                                    <div className='w-full h-full flex flex-col justify-between relative py-3 gap-3 2xl:py-8 z-50'>
                                        <div className='w-full h-auto flex flex-col justify-center items-center gap-2'>
                                            <img src={item.icon} alt="icons" className='mx-auto w-auto h-auto' />
                                            <h1 className='text-center font-bold font-nunito text-xl 2xl:text-2xl'>{item.title}</h1>
